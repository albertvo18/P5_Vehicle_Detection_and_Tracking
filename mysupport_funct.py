...
def detect_vehicles(img, ystart, ystop, scale, cspace, hog_channel, svc, X_scaler, orient,
...
def draw_bboxes_for_cars():
    ...
    scale = 1.0
    hog_channel='ALL'
    rects.append(detect_vehicles(test_img, ystart, ystop, scale, colorspace, hog_channel, svc, None,
    ...
    test_img_rects = draw_search_space_boxes2(test_img, rectangles, color='random', thick=2)
